...
this.eventEdriverService.publishEvent({ type: ProductActionsType.DELETE_PRODUCTS, payload: p })
  ...
  onSelect(p: Product) {
   ...
   this.eventEdriverService.publishEvent({ type: ProductActionsType.SELECT_PRODUCTS, payload: p })

  }

  onEdit(p: Product) {
   // this.productItemEventEmitter.emit({ type: ProductActionsType.EDIT_PRODUCTS, payload: p });
    this.eventEdriverService.publishEvent({ type: ProductActionsType.EDIT_PRODUCTS, payload: p })
